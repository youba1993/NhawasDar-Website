                ...
                <div className="form-group col-md-6 offset-md-3 mt-5">
                  <div className="card">
                    <h4 className="card-header">
                      {house ? "Update house" : "Liste a new House"}{" "}
                    </h4>
                    <div className="card-body">
                      <form
                        className="form-group col-md-6 offset-md-3 mt-5"
                        onSubmit={(e) => {
                          house ? handleUpdate(e) : handleSubmit(e);
                        }}
                      >
                        {!house && (
                        ...
                        <div className="form-group row">
                          <label className="custom-control-label">
                            <input
                              ...
                              name="air_cond"
                              value={listing.air_cond}
                              onChange={(e) => {
                                handleChange(e);
                              }}
                              checked={listing.air_cond}
                            />
                            Air conditioner
                          </label>
                          <label className="custom-control-label">
